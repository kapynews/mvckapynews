...
namespace KapyApp.Controllers
{
    public class SourcesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "sourceId,sourceName,sourceUrl")] Source source)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "sourceId,sourceName,sourceUrl")] Source source)
        {
            if (ModelState.IsValid)
            {
